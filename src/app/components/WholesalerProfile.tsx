...
export function WholesalerProfile() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] pb-20">
      ...
      <div className="bg-white px-6 py-4 shadow-sm flex items-center gap-4">
        <button onClick={() => navigate("/wholesaler")} className="p-1">
      ...
      <div className="px-6 py-6 space-y-4">
        ...
        <div className="bg-white rounded-[12px] p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[14px] text-gray-600">Wholesaler</p>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-[12px] p-4 shadow-sm">
            ...
            <p className="font-bold text-[#1A1A1A] text-[20px]">{stats.totalOrders}</p>
          </div>
          <div className="bg-white rounded-[12px] p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              <Bell className="w-5 h-5 text-[#E8453C]" />
              <p className="text-[14px] text-gray-600">Active Quotes</p>
            </div>
            <p className="font-bold text-[#1A1A1A] text-[20px]">{stats.activeQuotations}</p>
          </div>
          <div className="bg-white rounded-[12px] p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              <TrendingUp className="w-5 h-5 text-[#E8453C]" />
              <p className="text-[14px] text-gray-600">Revenue</p>
            </div>
            <p className="font-bold text-[#1A1A1A] text-[20px]">{stats.totalRevenue}</p>
          </div>
          <div className="bg-white rounded-[12px] p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[20px]">⭐</span>
              <p className="text-[14px] text-gray-600">Rating</p>
            </div>
            <p className="font-bold text-[#1A1A1A] text-[20px]">{stats.rating}/5</p>
          </div>
        </div>
